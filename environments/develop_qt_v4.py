...
#计算多部模拟的效益
    ...
    # agent 看到的饱和度和压力场
        ...
        # print('in develop check well loc +++++', self.total_well_loc.shape)
        ...
        assert state.shape[0] == self.args.state_dim[0], f'输出的state维度和设定不一致，井维度是，输出{state.shape[0]},设定的是{self.args.state_dim}'
