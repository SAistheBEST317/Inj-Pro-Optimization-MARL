...
from environments.env_utils_q import write_and_run,  check_field, check_indice, npv_fun , agent_npv, agg_adj

from shutil import copy, copytree, rmtree
import seaborn as sns
import pandas as pd
class development_q4(Env):  
    #path 为不带后缀的母文件名
...
#计算多部模拟的效益
    ...
    # agent 看到的饱和度和压力场
        ...
        state = np.stack([well_sat, well_pres, well_step],axis = 1).flatten()#[n,3,z,r,r]
